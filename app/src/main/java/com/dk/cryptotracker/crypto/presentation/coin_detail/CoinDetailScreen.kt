...
import com.dk.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
import com.dk.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.dk.cryptotracker.crypto.presentation.coin_list.components.previewCoin
import com.dk.cryptotracker.crypto.presentation.models.toDisplayableNumber
        ...
        Column(
            ...
            FlowRow(
                ...
                val absoluteChangeFormatted =
                    (coin.priceUsd.value * (coin.changePercent24Hr.value.div(100)))
                        .toDisplayableNumber()
            ...
            AnimatedVisibility(
                ...
                LineChart(
                    ...
                    style = ChartStyle(
                        chartLineColour = MaterialTheme.colorScheme.primary,
                        unselectedColour = MaterialTheme.colorScheme.secondary.copy(
                            alpha = 0.3f
                        ),
